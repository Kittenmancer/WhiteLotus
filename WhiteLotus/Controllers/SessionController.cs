...
namespace WhiteLotus.Controllers
{
    public class SessionController : BaseController
    {
        ...
        public ActionResult Login(string username, string password, string from = null)
        {
            ...
            var user = new Models.Queries.UserFromEmail(username).Execute(_session);
            ...
            if (user != null)
            {
                Session[Filters.LoadLoggedInUserAttribute.CurrentUserIdKey] = user.Id;
        ...
        {
            Session.Remove(Filters.LoadLoggedInUserAttribute.CurrentUserIdKey);
            return RedirectToAction("Index", "Home");
        }
